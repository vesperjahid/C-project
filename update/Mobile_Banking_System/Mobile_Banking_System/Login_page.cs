...
namespace Mobile_Banking_System
{
    public partial class Login_page : Form
    {
        ...
        private void Login_page_Load(object sender, EventArgs e)
        {
            ...
            {
                comboBox1.Items.Add(dr[16].ToString());
            }
        }
        ...
        private void login_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select count(*) from employee_acc where employee_id = '"+textBox1.Text+ "' and password = '" + textBox2.Text + "' and acount_type = '" + comboBox1.Text.ToString() + "' ", conn);
